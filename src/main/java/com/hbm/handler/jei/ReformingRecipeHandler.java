...
import com.hbm.handler.jei.JeiRecipes.ReformingRecipe;
...
public class ReformingRecipeHandler implements IRecipeCategory<ReformingRecipe> {
	...
	public ReformingRecipeHandler(IGuiHelper help) {
		background = help.createDrawable(gui_rl, 34, 34, 108, 18);
	}
	
	@Override
	public String getUid() {
		return JEIConfig.REFORMER;
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, ReformingRecipe recipeWrapper, IIngredients ingredients) {
