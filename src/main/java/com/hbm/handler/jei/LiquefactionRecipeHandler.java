...
import com.hbm.handler.jei.JeiRecipes.LiquefactionRecipe;
...
public class LiquefactionRecipeHandler implements IRecipeCategory<LiquefactionRecipe> {
	...
	public String getTitle() {
		return I18nUtil.resolveKey("container.machineLiquefactor");
	}
	...
	@Override
	public void setRecipe(IRecipeLayout recipeLayout, LiquefactionRecipe recipeWrapper, IIngredients ingredients) {
