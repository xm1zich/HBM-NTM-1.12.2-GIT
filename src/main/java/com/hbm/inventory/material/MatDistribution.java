...
public class MatDistribution {
	...
	public static void registerDefaults() {
		...
		registerEntry(Blocks.IRON_DOOR, MAT_IRON, INGOT.q(2));
		...
		registerEntry(Blocks.CAULDRON, MAT_IRON, INGOT.q(7));
		...
		registerEntry(Blocks.GOLDEN_RAIL, MAT_GOLD, INGOT.q(1), MAT_REDSTONE, DUST.q(1, 6));
		registerEntry(Blocks.DETECTOR_RAIL, MAT_IRON, INGOT.q(1), MAT_REDSTONE, DUST.q(1, 6));
		registerEntry(Blocks.ACTIVATOR_RAIL, MAT_IRON, INGOT.q(1), MAT_REDSTONE, DUST.q(1, 6));
		registerEntry(Blocks.FURNACE, MAT_STONE, BLOCK.q(8));
		
		registerEntry(Blocks.PISTON, MAT_STONE, INGOT.q(4), MAT_IRON, INGOT.q(1), MAT_REDSTONE, DUST.q(1));
		registerEntry(Blocks.STICKY_PISTON, MAT_STONE, INGOT.q(4), MAT_IRON, INGOT.q(1), MAT_REDSTONE, DUST.q(1));
		...
		registerEntry(Items.HOPPER_MINECART, MAT_IRON, INGOT.q(5));
		...
		registerEntry(new ItemStack(ModItems.mold, 1, OreDictionary.WILDCARD_VALUE),						MAT_IRON,			INGOT.q(1));
